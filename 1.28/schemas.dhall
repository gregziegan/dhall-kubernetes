...
, ParamKind = ./schemas/io.k8s.api.admissionregistration.v1beta1.ParamKind.dhall
, ParamRef = ./schemas/io.k8s.api.admissionregistration.v1beta1.ParamRef.dhall
, TypeChecking =
...
, Variable = ./schemas/io.k8s.api.admissionregistration.v1beta1.Variable.dhall
...
, HostIP = ./schemas/io.k8s.api.core.v1.HostIP.dhall
...
, IPAddress = ./schemas/io.k8s.api.networking.v1alpha1.IPAddress.dhall
, IPAddressList = ./schemas/io.k8s.api.networking.v1alpha1.IPAddressList.dhall
, IPAddressSpec = ./schemas/io.k8s.api.networking.v1alpha1.IPAddressSpec.dhall
, ParentReference =
...
, ResourceClass = ./schemas/io.k8s.api.resource.v1alpha2.ResourceClass.dhall
, ResourceClassList =
...
, ResourceHandle = ./schemas/io.k8s.api.resource.v1alpha2.ResourceHandle.dhall
